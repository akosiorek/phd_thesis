...
\begin{figure}[ht!]
\centering
\includegraphics[width=1\textwidth]{Figures/tracking_qualitative.pdf}
\vspace{-8mm}
...
\begin{figure}
    ...
    \begin{subfigure}[c]{0.99\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/prediction_motc2.png}
        \vspace{-6mm}
    ...
    \begin{subfigure}[c]{0.99\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Figures/prediction_detrac2.png}
        \vspace{-6mm}
