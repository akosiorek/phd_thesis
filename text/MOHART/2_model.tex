...
It is used to mark whether an object should interact with other objects, as well as to mask the loss function (described in \cite{Kosiorek2017hierch}) for the given object when it is not present.
