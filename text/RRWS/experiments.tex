...
% \begin{figure}
%   \includegraphics[width=\linewidth]{figures/RRWS/pcfg/errors_end_points.pdf}
%   \caption{}
%   \label{fig:experiments/pcfg/astronomers_errors}
% \end{figure}
\begin{figure*}
  \centering
  % \includegraphics[width=0.94\textwidth]{figures/RRWS/pcfg/errors.pdf}
...
% \begin{figure*}
%   \includegraphics[width=\textwidth]{figures/RRWS/pcfg/both_errors.pdf}
%   \caption{}
%   \label{fig:experiments/pcfg/astronomers_errors}
% \end{figure*}
...
% \begin{figure*}
%   \includegraphics[width=\textwidth]{figures/RRWS/pcfg/ws.eps}
%   \includegraphics[width=\textwidth]{figures/RRWS/pcfg/vimco.eps}
% \end{figure*}
...
\begin{figure*}[!ht]
  \centering
  % \includegraphics[width=0.9\textwidth]{figures/RRWS/gmm/plot_paper.pdf}
  % \includegraphics[width=0.89\textwidth]{figures/RRWS/gmm/errors.pdf}
...
%   \centering
%   \vspace*{-3ex}
%   \includegraphics[width=0.95\linewidth,trim={1em 0 1em 1em},clip]{figures/RRWS/gmm_true_dist.pdf}
%   \vspace*{-2.5ex}
...
\begin{figure*}[!ht]
  \centering
  % \includegraphics[width=\textwidth]{figures/RRWS/gmm/plot_paper_2.pdf}
  % \includegraphics[width=\textwidth]{figures/RRWS/gmm/plot_paper_2_stair.pdf}
  % \includegraphics[width=0.9\textwidth]{figures/RRWS/gmm/plot_paper_3.pdf}
