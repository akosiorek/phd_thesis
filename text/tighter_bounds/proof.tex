...
%\footnote{Note the significance of using Taylor's theorem
%rather than a Taylor expansion as this allows us to provide a precise form for
%the remainder, rather than having to worry about an infinite series.}  
to 
