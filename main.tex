...
%	\input{text/00_abstract} % Create an abstract.tex file in the 'text' folder for your abstract.
...
\input{text/02_literature_review}
...
\label{ch:mohart}
\input{text/MOHART/mohart}

\chapter{Sequential Attend, Infer, Repeat: Generative Modelling of Moving Objects}
\label{ch:sqair}
\input{text/SQAIR/sqair}
%\includepdf[pages=-,pagecommand={\thispagestyle{plain}}]{figures/authorship/sqair.pdf}
...
\input{text/09_discussion}


%\include{text/tighter_bounds/tighter_bounds}
%\include{text/RRWS/rrws}
